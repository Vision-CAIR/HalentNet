...
class GMM2D(td.Distribution):
    ...
    def rsample(self, sample_shape=torch.Size()):  # sample is differentiable w.r.t mus and L, but might not to logits (new traj++ only use gaussian dist(gmm with 1 component), doesn't matter)
        """
