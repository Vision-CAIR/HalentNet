...
class Scene(object):
    def __init__(self, timesteps, map=None, dt=1, name="", frequency_multiplier=1, aug_func=None, non_aug_scene=None, scene_token=None, sample_token_list=None):
        self.map = map
    ...
    def present_nodes(self,
        ...
        :param timesteps: Timestep(s) for which all present nodes should be returned (np.array)
